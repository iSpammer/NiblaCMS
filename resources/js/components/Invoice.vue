                ...
                <div class="col-12">
                        ...
                        <div class="invoice p-3 mb-3">
                          ...
                          <div class="row">
                            <div class="col-12">
                              <h4>
                                <i class="fa fa-globe"></i> Nibla, Inc.
                          ...
                          <div class="row invoice-info">
                            ...
                            <div class="col-sm-4 invoice-col">
                              To
                              <address>
                                <strong>Ossama Akram</strong><br>
                                Banafseg 3 1st Settlement<br>
                                Cairo, Egypt<br>
                                Phone: (20) 0100-4746-085<br>
                                Email: ispamossama@gmail.com
                              </address>
                            </div>
                            <!-- /.col -->
                            <div class="col-sm-4 invoice-col">
