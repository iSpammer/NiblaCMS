...
<div class="wrapper" id="app">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      <img src="/img/shaar.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-light">Nibla Studio</span>
    </a>
        ...
        <ul class="nav nav-treeview">
          <li class="nav-item">
            <router-link to="/developer" class="nav-link">
                <i class="nav-icon fas fa-key cyan"></i>
                    <p>
                    API Keys
                    </p>
            </router-link>
          ...
          <li class="nav-item">
            <a href="/telescope" class="nav-link">
              <i class="fas fa-binoculars nav-icon teal"></i>
              <p>Telescope</p>
            </a>
          </li>
      ...
      @endif
        <li class="nav-item">
            <router-link to="/invoice" class="nav-link">
                <i class="nav-icon fas fa-sticky-note indigo"></i>
                    <p>
                    Invoice
                    </p>
                </router-link>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2019-2019 OssamaCRM.</strong> All rights reserved.
  </footer>
</div>
<!-- ./wrapper -->
@auth
